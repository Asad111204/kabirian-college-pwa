...
try {
  ...
  log('verify')
  for (const v of ['verify.mjs', 'verify-notices.mjs', 'verify-security.mjs', 'verify-pwa.mjs', 'verify-attendance.mjs', 'verify-photos.mjs', 'verify-homework.mjs', 'verify-marks-deadline.mjs', 'verify-staff-attendance.mjs']) {
    console.log(`\n--- ${v}`)
