...
| **Assign a subject** | Session → Class → Division → Program → Section → Subject. Only combinations that exist are offered, and only subjects in that program's curriculum. Staff type does not decide this: somebody who runs the office and also teaches two classes can hold subjects without being relabelled. |
