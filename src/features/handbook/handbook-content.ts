...
export const HANDBOOK_PARTS: HandbookPart[] = [
  {
    ...
    summary: 'One place for the school’s records, used by the office, the teachers and the students.',
    where: 'Any browser, and installable on a phone',
    paragraphs: [
      'The Nova School Kamalia Management System keeps the records the school runs on: who the students are, where they sit, whether they attended, what they scored, what they owe, and what the school spent. It replaces the separate registers, spreadsheets and files those things used to live in.',
...

  {
    ...
    steps: [
      'Open the school’s address in a browser.',
...

  {
    ...
    paragraphs: [
      'Everything else hangs off this, so it is built first and changed rarely. An academic session is a year, such as 2026-27, and one of them is the current one. Within a session the school defines classes (PG, Pre-Nursery, Nursery, KG and Class 1 to Class 10), divisions (one General division to begin with, or Boys and Girls if the school separates them) and programmes (General, or Science and Arts for the senior classes).',
...

  {
    ...
    paragraphs: [
      ...
      'The same form takes the year’s fee, head by head — tuition, annual funds, events funds, board registration, board admission, a tour and anything else the school names. Every one of them is optional: fill in what applies and leave the rest empty.',
...

  {
    ...
    paragraphs: [
      ...
      'The office sees today’s registers at a glance on the dashboard, and the reports give a percentage per student, per subject, per section, per class or per programme, in the school’s colour bands: below 75 red, 75 to 79 amber, 80 to 89 light green, 90 and above dark green.',
    ],
    rules: [
      {
...

  {
    ...
    paragraphs: [
      'A staff record holds the person, their designation and department, their joining date, their qualification and — for whoever may see the school’s money — their monthly salary. Teachers are then assigned to a section and a subject, and those assignments are what let them take a register or enter marks.',
    ...
    rules: [
      {
        ...
        because: 'It is the school’s record of its own employees, not something taken by the people it is about.',
      },
    ],
  },
...

  {
    ...
    paragraphs: [
      ...
      'A teacher sees their own week and today’s lessons on their dashboard. There is no student timetable, by the school’s decision.',
...

  {
    ...
    summary: 'What the school tells people, and what they tell the school.',
...

  {
    ...
    paragraphs: [
      'The school charges one fee for the year, made up of named heads: tuition, annual funds, events funds, board registration, board admission, a tour and anything else. Each student’s amounts are set when they are admitted and can be changed on their record afterwards. A concession comes off the year’s total.',
      ...
      'A voucher prints as three copies on one A4 sheet — bank, school, student — and shows what has been paid and what is left. The year’s total is deliberately not on it: a family paying in instalments needs one number at the counter.',
    ],
    steps: [
  ...
  {
    title: 'Finance',
    summary: 'What the school spends, against what the fees bring in.',
    where: 'Admin, Finance',
    paragraphs: [
...

  {
    ...
    paragraphs: [
      ...
      'Opening a page clears that part of the school; opening one notification clears just that one. Notifications arrive when the app is opened — reaching a closed phone needs a push service, which the school has not asked for.',
    ],
    rules: [
      {
    ...
    rules: [
      {
        ...
        because: 'Both are ways a person could lock the school out or promote themselves. Another administrator does it.',
      },
      {
...

  {
    ...
    paragraphs: [
      ...
      'The database is hosted by Neon and the application by Vercel, both on their free tiers. Files are in the school’s own Google Drive. If the Drive connection is ever lost, reconnect it from Admin, Settings; the record of every document survives regardless.',
...
export const HANDBOOK_SUBTITLE = 'A complete guide to the school management system: what it does, who may do it, and the rules it keeps.'
